...
import uk.gov.hmrc.plasticpackagingtaxregistration.util.Obfuscation.StringObfuscationOps
import uk.gov.hmrc.plasticpackagingtaxregistration.validators.PptSchemaValidator
...
class SubscriptionService @Inject()(subscriptionsConnector: SubscriptionsConnector,
  ...
  private def handleSuccessfulSubscription(subscriptionResponse: SubscriptionSuccessfulResponse,
                                           safeId: String,
